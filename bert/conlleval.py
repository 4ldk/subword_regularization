...
def get_result(
    ...
    out_text += f"processed {sum_true_counts} tokens with {sum_true_chunks} phrases; "
    out_text += f"found: {sum_pred_chunks} phrases; correct: {sum_correct_chunks}.\n"
...
if __name__ == "__main__":
    ...
    """
    path = "C:/Users/chenr/Desktop/python/subword_regularization/outputs/bert_pred_roop/2023-10-19/03-06-50/output.txt"
