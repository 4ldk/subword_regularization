...
from transformers import AutoModelForTokenClassification, RobertaConfig

sys.path.append(os.path.join(os.path.dirname(__file__), "."))
from utils.bpe_dropout import RobertaTokenizerDropout
from utils.utils import get_dataloader, path_to_data, val_to_key, dataset_encode
...
def loop_pred(
    ...
    if local_model:
        config = RobertaConfig.from_pretrained(model_name, num_labels=len(ner_dict))
