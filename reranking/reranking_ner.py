...
from reranking_utils import RerankingDataset, reranking_dataset, get_dataset_from_100pred
...
def main():
    save_path = "./outputs/reranking/model_large"
    ...
    dataset["inputs"] = tokenizer.batch_encode_plus(dataset["Replaced_sentence"], padding="max_length", max_length=512, return_tensors="pt")
